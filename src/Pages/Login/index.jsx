        ...
        <MDBCol col='12'>
          <MDBCard className='bg-dark text-white my-5 mx-auto' style={{borderRadius: '1rem', maxWidth: '400px'}}>
            <MDBCardBody className='p-5 d-flex flex-column align-items-center mx-auto w-100'>
              ...
              <Button variant="danger" className='mx-2 px-5' size='lg'>
                Logar
              </Button>
              ...
              <div>
                <p className="mb-0">Crie sua conta! <a href="#!" className="text-white-50 fw-bold">Registrar-se</a></p>
              </div>
              <Button variant="danger" className='mt-3 px-5' size='lg' onClick={onClose}>
                Fechar
              </Button>
            </MDBCardBody>
          </MDBCard>
